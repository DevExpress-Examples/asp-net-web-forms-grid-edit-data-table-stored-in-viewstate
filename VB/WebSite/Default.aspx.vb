...
Partial Public Class _Default
    ...
    Protected Sub grid_RowDeleting(ByVal sender As Object, ByVal e As ASPxDataDeletingEventArgs)
        ...
        Dim dr As DataRow = CustomDataSourse.Rows.Find(id_Renamed)
    ...
    Private Sub grid_RowValidating(ByVal sender As Object, ByVal e As ASPxDataValidationEventArgs)
        ...
        Dim id_Renamed As Integer = CInt((e.NewValues("Id")))
        If ((Not e.OldValues.Contains("Id")) OrElse (CInt((e.OldValues("Id"))) <> id_Renamed)) AndAlso (CustomDataSourse.Rows.Find(id_Renamed) IsNot Nothing) Then
            Dim grid As ASPxGridView = TryCast(sender, ASPxGridView)
            e.Errors(grid.Columns("Id")) = String.Format("Column 'Id' is constrained to be unique.  Value '{0}' is already present.", id_Renamed)
        End If
    End Sub
